...
namespace XLua
{
    public partial class DelegateBridge_Wrap : DelegateBridge
    {
		...
		public void __Gen_Delegate_Imp2(int p0, bool p1, string p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp8(UnityEngine.Vector3 p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(System.Action<int, bool, string>))
			{
			    return new System.Action<int, bool, string>(__Gen_Delegate_Imp2);
			}
			...
			{
			    return new System.Action<UnityEngine.Vector3>(__Gen_Delegate_Imp8);
			}
