...
namespace AssetFormatter {
    ...
    {
        const string settingPath = "Assets/Editor/TextureFormatter/Setting/TFSetting.asset";
        ...
        void DrawTextureSettingItem(TextureFormat tf, FormatPathPair fpp)
        {
            ...
            GUILayout.Label("", GUILayout.MaxWidth(20));
            GUILayout.Label("anisoLevel", GUILayout.MaxWidth(80));
            fpp.anisoLevel = EditorGUILayout.IntField(fpp.anisoLevel, GUILayout.MaxWidth(20));
            GUILayout.Label("", GUILayout.MaxWidth(20));
        ...
        static void ApplyModelImporter(ApplyData ad)
        {
            ...
            if (mi != null)
            {
                ...
                {
                    if ( ((platformName == "Android" || platformName == "iPhone") && mi.importNormals != ModelImporterNormals.None) || mi.isReadable != fpp.isReadable || mi.meshCompression != ModelImporterMeshCompression.Medium || !mi.optimizeGameObjects || mi.animationCompression != ModelImporterAnimationCompression.Optimal || !mi.optimizeMesh || mi.indexFormat != ModelImporterIndexFormat.UInt16)
                    {
