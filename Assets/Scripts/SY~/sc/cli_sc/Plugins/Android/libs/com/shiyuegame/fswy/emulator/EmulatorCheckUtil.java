package com.shiyuegame.fswy.emulator;
...
import static com.shiyuegame.fswy.emulator.CheckResult.RESULT_EMULATOR;
import static com.shiyuegame.fswy.emulator.CheckResult.RESULT_MAYBE_EMULATOR;
import static com.shiyuegame.fswy.emulator.CheckResult.RESULT_UNKNOWN;
...
public class EmulatorCheckUtil {
    ...
    private CheckResult checkFeaturesByHardware() {
        ...
        if (tempValue.equals("ttvm") //天天模拟器
        	||tempValue.equals("nox")//夜神模拟器
        	||tempValue.equals("cancro")//网易MUMU模拟器
        	||tempValue.equals("intel")//逍遥模拟器
        	||tempValue.equals("vbox")
        	||tempValue.equals("vbox86")//腾讯手游助手
        	||tempValue.equals("android_x86")//雷电模拟器
        	){
