BattlePvePreLoadSystem = BaseClass("BattlePvePreLoadSystem",SECBSystem)
BattlePvePreLoadSystem.NAME = "BattlePreLoadSystem"

function BattlePvePreLoadSystem:__Init()
...
function BattlePvePreLoadSystem:InitMaskCamera(maskCamera)
...
function BattlePvePreLoadSystem:PreLoadBattleAsset()
    ...
    -- for k, v in pairs(mod.BattleProxy.readyEnterData.role_list) do --TODO 修改
...
function BattlePvePreLoadSystem:PreLoadBattleNode()
...
function BattlePvePreLoadSystem:BattleNodeLoaded()
...
function BattlePvePreLoadSystem:PreLoadPveMainPanel()
    local assetList = {}
    table.insert(assetList,{file = "ui/prefab/battle/pve_main_panel.prefab", type = AssetType.Prefab})
...
function BattlePvePreLoadSystem:MainPanelLoaded()
    ...
    self:CheckPreLoadComplete(self.preLoadInfo["pveMainPanel"].order)
end

function BattlePvePreLoadSystem:PreLoadScene()
    local sceneFile = "scene/1004/1004.prefab"
...
function BattlePvePreLoadSystem:SceneLoaded()
...
-- function BattlePvePreLoadSystem:PreLoadOperateTexture()
--     local operateTextureList = {}
    ...
    --     local unitIcon = {}
    --     unitIcon.file = AssetPath.GetBattleOperateIcon(v.unit_id)
...
-- function BattlePvePreLoadSystem:SetPreLoadUnitTposeList(levelToNum)
...
-- function BattlePvePreLoadSystem:PreLoadUnitTpose()
...
-- function BattlePvePreLoadSystem:OnSingleUnitTposeLoaded()
--     self.unitTposeLoadNum = self.unitTposeLoadNum - 1
...
-- function BattlePvePreLoadSystem:SetPreLoadBattleEffectList(levelToNum)
...
function BattlePvePreLoadSystem:SetBattleEffect(effectId,levelToNum)
...
function BattlePvePreLoadSystem:PreLoadBattleEffect()
    local assetList = {}
...
function BattlePvePreLoadSystem:OnBattleEffectLoaded()
...
function BattlePvePreLoadSystem:ClearLoadersAndAsset()
...
function BattlePvePreLoadSystem:CheckPreLoadComplete(order)
...
function BattlePvePreLoadSystem:PreLoadComplete()
    self:RemoveWaitTimer()
    self:SetMapToBattleNode()
    RunWorld.BattleEnterSystem:EnterComplete()
end

function BattlePvePreLoadSystem:RemoveWaitTimer()
...
function BattlePvePreLoadSystem:SetMapToBattleNode()
