PvpPreLoadSystem = BaseClass("PvpPreLoadSystem",SECBSystem)
PvpPreLoadSystem.NAME = "BattlePreLoadSystem"

function PvpPreLoadSystem:__Init()
    
end

function PvpPreLoadSystem:InitMaskCamera(maskCamera)
...
function PvpPreLoadSystem:InitData()
...
function PvpPreLoadSystem:PreLoadBattleAsset()
    self:InitData()
...
function PvpPreLoadSystem:PreLoadBattleNode()
...
function PvpPreLoadSystem:BattleNodeLoaded()
...
function PvpPreLoadSystem:PreLoadBattleMainPanel()
    local assetList = {}
...
function PvpPreLoadSystem:MainPanelLoaded()
...
function PvpPreLoadSystem:PreLoadScene()
...
function PvpPreLoadSystem:SceneLoaded()
...
function PvpPreLoadSystem:PreLoadOperateTexture()
...
function PvpPreLoadSystem:SetPreLoadUnitTposeList(levelToNum)
...
function PvpPreLoadSystem:PreLoadUnitTpose()
...
function PvpPreLoadSystem:OnSingleUnitTposeLoaded()
    self.unitTposeLoadNum = self.unitTposeLoadNum - 1
...
function PvpPreLoadSystem:SetPreLoadBattleEffectList(levelToNum)
...
function PvpPreLoadSystem:SetBattleEffect(effectId,levelToNum)
...
function PvpPreLoadSystem:PreLoadBattleEffect()
    local assetList = {}
...
function PvpPreLoadSystem:OnBattleEffectLoaded()
...
function PvpPreLoadSystem:ClearLoadersAndAsset()
...
function PvpPreLoadSystem:CheckPreLoadComplete(order)
...
function PvpPreLoadSystem:RemoveWaitTimer()
...
function PvpPreLoadSystem:SetMapToBattleNode()
