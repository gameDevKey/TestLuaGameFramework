NotBlockFloorEntityAIAction = BaseClass("NotBlockFloorEntityAIAction",BTAction)

function NotBlockFloorEntityAIAction:__Init()
    self.moveComplete = false
end

function NotBlockFloorEntityAIAction:__Delete()

end

function NotBlockFloorEntityAIAction:OnStart()

end

function NotBlockFloorEntityAIAction:OnUpdate(deltaTime)
...
function NotBlockFloorEntityAIAction:MoveToTargetFinish()
    self.moveComplete = true
end