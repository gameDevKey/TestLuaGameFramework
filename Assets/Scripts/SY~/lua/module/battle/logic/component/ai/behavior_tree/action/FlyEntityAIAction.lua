FlyEntityAIAction = BaseClass("FlyEntityAIAction",BTAction)

function FlyEntityAIAction:__Init()
    self.moveComplete = false
end

function FlyEntityAIAction:__Delete()

end

function FlyEntityAIAction:OnStart()

end

function FlyEntityAIAction:OnUpdate(deltaTime)
...
function FlyEntityAIAction:MoveToTargetFinish()
    self.moveComplete = true
end