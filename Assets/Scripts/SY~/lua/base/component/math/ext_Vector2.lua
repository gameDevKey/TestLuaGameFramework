local get = xlua.getmetatable(CS.UnityEngine.Vector2)
...
__extends.up 		= function() return setmetatable({x = 0, y = 1}, Vector2) end
__extends.right	= function() return setmetatable({x = 1, y = 0}, Vector2) end
__extends.zero	= function() return setmetatable({x = 0, y = 0}, Vector2) end
__extends.one		= function() return setmetatable({x = 1, y = 1}, Vector2) end

__extends.magnitude 		= Vector2.Magnitude
__extends.normalized 		= Vector2.Normalize
__extends.sqrMagnitude 	= Vector2.SqrMagnitude
