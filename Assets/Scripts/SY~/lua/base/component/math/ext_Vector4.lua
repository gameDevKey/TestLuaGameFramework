local get = xlua.getmetatable(CS.UnityEngine.Vector4)
...
__extends.zero = function() return Vector4.New(0, 0, 0, 0) end
__extends.one	 = function() return Vector4.New(1, 1, 1, 1) end

__extends.magnitude 	 = Vector4.Magnitude
__extends.normalized 	 = Vector4.Normalize
__extends.sqrMagnitude = Vector4.SqrMagnitude

setmetatable(Vector4, Vector4)

---------------------------------------------------------
xlua.setmetatable(CS.UnityEngine.Vector4, Vector4)
xlua.setclass(CS.UnityEngine, 'Vector4', Vector4)