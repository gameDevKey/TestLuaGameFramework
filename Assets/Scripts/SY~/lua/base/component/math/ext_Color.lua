local get = xlua.getmetatable(CS.UnityEngine.Color)
...
__extends.red 	= function() return Color.New(1,0,0,1) end
__extends.green	= function() return Color.New(0,1,0,1) end
__extends.blue	= function() return Color.New(0,0,1,1) end
__extends.white	= function() return Color.New(1,1,1,1) end
__extends.black	= function() return Color.New(0,0,0,1) end
__extends.yellow	= function() return Color.New(1, 0.9215686, 0.01568628, 1) end
__extends.cyan	= function() return Color.New(0,1,1,1) end
__extends.magenta	= function() return Color.New(1,0,1,1) end
__extends.gray	= function() return Color.New(0.5,0.5,0.5,1) end
__extends.clear	= function() return Color.New(0,0,0,0) end

__extends.gamma = function(c) 
  return Color.New(Mathf.LinearToGammaSpace(c.r), Mathf.LinearToGammaSpace(c.g), Mathf.LinearToGammaSpace(c.b), c.a)  
end

__extends.linear = function(c)
  return Color.New(Mathf.GammaToLinearSpace(c.r), Mathf.GammaToLinearSpace(c.g), Mathf.GammaToLinearSpace(c.b), c.a)
end

__extends.maxColorComponent = function(c)    
  return Mathf.Max(Mathf.Max(c.r, c.g), c.b)
end

__extends.grayscale = Color.GrayScale
