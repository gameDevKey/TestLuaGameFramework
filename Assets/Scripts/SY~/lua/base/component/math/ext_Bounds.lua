local get = xlua.getmetatable(CS.UnityEngine.Bounds)
...
__extends.size = Bounds.GetSize
__extends.min = Bounds.GetMin
__extends.max = Bounds.GetMax

setmetatable(Bounds, Bounds)

---------------------------------------------------------
xlua.setmetatable(CS.UnityEngine.Bounds, Bounds)
xlua.setclass(CS.UnityEngine, 'Bounds', Bounds)